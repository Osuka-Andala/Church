	...
	if(isset($_POST["update_an_episode"])){
            if(isset($_POST["series_id"])){
                ...
                if(isset($_POST["visible"])){
                    $updateEpisodes = $db->updateAllEpisodes($title, $number_img, $start, $week, $end, $vid, $pastor, $audio, $desc, $img, $webpage, 'y', $id);
                    $message = $title." - Updated successfully";
                }else{
                    $updateEpisodes = $db->updateAllEpisodes($title, $number_img, $start, $week, $end, $vid, $pastor, $audio, $desc, $img, $webpage, 'n', $id);
                    $message = $title." - Updated successfully";
                }
            }
	}
    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                ...
                <li class="active">Series 1</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
        	<h1>Series 1 Episodes</h1> <span>Here you update series 1 episodes info</span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
        	<div class="contentinner">
                ...
                <div class="widgetcontent">
                    <ol class="devices">
                    <?php
                        $allEpisodes = $db->getAllEpisodes(1);
                        ...
                        <li>
                            <form id="<?php echo $row["id"] ?>" class="stdform" name="" method="post">
                                ...
                                <p>
                                    ...
                                    <span class="field"><input type="text" name="end_date" class="input-xxlarge" value="<?php echo $row["EPISODE_END_DATE"] ?>" /></span>
                                </p> 
                                <p>
