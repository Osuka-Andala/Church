    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                ...
                <li><a href="series2.php">Series 2</a> <span class="divider">/</span></li>
                <li><a href="series3.php">Series 3</a> <span class="divider">/</span></li>
                <li><a href="series4.php">Series 4</a> <span class="divider">/</span></li>
                <li><a href="series5.php">Series 5</a> <span class="divider">/</span></li>
                <li><a href="series6.php">Series 6</a> <span class="divider">/</span></li>
                <li class="active">Series 7</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
        	<h1>Series 7 Episodes</h1> <span>Here you update series 7 episodes info</span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
        	<div class="contentinner">
                ...
                <div class="widgetcontent">
                    <ol class="devices">
                    <?php
                        $allEpisodes = $db->getAllEpisodes(7);
